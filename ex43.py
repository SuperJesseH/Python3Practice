...
class CentralCorridor(Scene):
	...
	def enter(self):
		print(dedent("""
			...
			Your're running down the central corridor to the Weapons Armory
			when a Gothon jumps out, red scaly skin, dark grimy teeth, and
			evil clow costume flowing around his hate filled body. He's blocking
		...
		if action == "shoot!":
			print(dedent("""
				...
				into and insane range and blast you repeatedly in the face
				until you are dea. Then he eats you.
				"""))
			return 'death'
		elif action == "dodge!":
			print(dedent("""
				Like a world class boxer you doge, weave, slip and slide right
				as the Gothon's blaster cranks a laser past your head. In the
				middle of your artful dodge your foot slips and you band you head
			...
			print(dedent("""
				...
				stops, tries not to laugh, then bursts out laughing and can't move.
...
class EscapePod(Scene):
	...
	def enter(self):
		print(dedent("""
			...
			like hardly andy Gothons are on the ship, so your run is
			clear of interference. You get to the chamber with the
			escape pods, and now need to pick on to the take. Some of
		...
		if (int(guess) != good_pod):
			...
			print(dedent("""
				...
				planet belwo. As it flies to the planet, you look
